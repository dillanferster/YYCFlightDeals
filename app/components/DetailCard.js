...
export default function DetailCard({ flightDetail }) {
  ...
  return (
    <div>
      {flightDetails?.departure_at &&
      flightDetails?.return_at &&
      flightDetails?.city &&
      flightDetails?.price ? (
              ...
              <div className="p-4 h-[25rem] flex flex-col justify-between gap-8">
                <div className="mb-4 flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="bg-gray-300 w-16 h-9 text-slate-900 rounded-full px-3 py-1 text-lg font-normal">
                      YYC
                    </div>
        ...
        <div className="flex flex-wrap items-center justify-center p-8 gap-4 bg-transparent">
          <div className="w-[30rem] h-[30rem] max-sm:w-[21rem] bg-white  rounded-xl shadow-lg flex flex-col justify-between ">
            <div className="flex flex-col justify-evenly h-[28rem] ">
              <div className="p-4 h-[25rem] flex flex-col justify-between gap-8">
                <div className="mb-4 flex flex-col gap-4">
                  <div className=" animate-pulse w-32 h-4 bg-gray-400 border rounded-xl mb-1 "></div>
                  <div className="flex items-center justify-between">
                    <div className="animate-pulse w-16 h-9 bg-gray-400 rounded-full px-3 py-1 "></div>
                    <div className="animate-pulse w-20 h-4 bg-gray-400 rounded-xl mb-1"></div>
                    <div className="bg-gray-400 animate-pulse w-16 h-9   rounded-full px-3 py-1 "></div>
                  </div>
                  <div className="flex justify-between text-sm text-gray-600 mt-2">
                    <div className="animate-pulse w-20 h-4 bg-gray-400 rounded-xl mb-1"></div>
                    <div className="animate-pulse w-32 h-4 bg-gray-400 rounded-xl mb-1"></div>
                  </div>
                </div>
                <div className="flex justify-center items-center border rounded-lg py-2 text-sm font-semibold text-gray-700">
                  <div className="animate-pulse w-36 h-4 bg-gray-400 rounded-xl mb-1"></div>
                </div>
                <div className="mt-4 flex flex-col gap-4">
                  <div className="animate-pulse w-32 h-4 bg-gray-400 border rounded-xl mb-1"></div>
                  <div className="flex items-center justify-between">
          ...
          <div className="h-[30rem] w-[12rem]  bg-white  rounded-xl shadow-lg flex flex-col justify-end max-md:h-[15rem] max-md:w-[30rem] max-sm:w-[21rem]">
            <div className="mb-[9.5rem] max-md:mb-[4rem]">
              <span className=" flex  justify-center font-medium text-lg text-slate-700">
                <div className="animate-pulse w-28 h-8 bg-gray-400 rounded-xl mb-1"></div>
              </span>
            </div>
