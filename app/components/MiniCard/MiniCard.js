  ...
  return (
    <Link href={`/details/${position}`}>
      ...
      >
        <div
          id="MiniCard"
          className="flex flex-col bg-[url('/Beach.jpeg')] bg-cover bg-left justify-end  items-center ease-in-out transition-all  border-2 border-black border-solid w-[4rem] rounded-md h-28 text-white"
        >
